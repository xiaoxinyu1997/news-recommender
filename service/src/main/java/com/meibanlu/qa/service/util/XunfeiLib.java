...
public class XunfeiLib  {
    ...
    private static Map<String,String> vioceError=new HashMap<String, String>();
     ...
     * 查看是否合成成功
     */
    public static Boolean checkError(String name){
        String error = XunfeiLib.vioceError.get(name);
    ...
    public static void setError(String name ,String erroe){
        XunfeiLib.vioceError.put(name, erroe);
    }

    /**
     * 清除信息
     */
    public static void delError(String name){
        XunfeiLib.vioceError.remove(name);
    }

    /**
     * 获取错误信息
     */
    public static String fetchError(String name){
        String error = XunfeiLib.vioceError.get(name);
        if(error == null || error.isEmpty()){
            return "0-null";
        }else{
        ...
        return new SynthesizeToUriListener() {
            ...
            public void onSynthesizeCompleted(String uri, SpeechError error) {
                if(error!=null){
                    ...
                    XunfeiLib.setError(uri, error.toString());
                }else{
    ...
    public static String getFileName(String name){
        ...
        if(os.contains("windows")){
            ...
            fileName
                    .append("/usr/share/nginx/html/music/")
                    .append(name);
        }
