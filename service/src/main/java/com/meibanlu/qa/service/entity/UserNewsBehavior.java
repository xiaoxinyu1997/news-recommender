...
public class UserNewsBehavior {
	...
	public String toString() {
		return "UserNewsBehavior [id=" + id + ", userid=" + userid + ", serviecetype=" + serviecetype
				+ ", originalLength=" + originalLength + ", durationOfPlay=" + durationOfPlay + ", startTime="
				+ startTime + ", endTime=" + endTime + ", newsid=" + newsid + "]";
	}
